...
# Load the map image
map_image_path = '/home/nvidia/depend_ws/src/F1tenth_car_workspace/base_mapping/map/base_map.pgm'
map_image = Image.open(map_image_path)
map_array = np.array(map_image)


# Map metadata from the YAML file
origin_x, origin_y = -5.050576, -2.112379  # Origin of the map
